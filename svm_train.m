...
for i=1:8
    ...
    load(mat_form);
    xtmp = [all_features.time.kurtosis,all_features.time.mean,all_features.time.median,all_features.time.skewness,all_features.frequency.mean_freq,all_features.frequency.median_freq,all_features.frequency.peak_freq];
    x = [x;xtmp];
